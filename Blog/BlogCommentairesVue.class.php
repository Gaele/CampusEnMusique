	...
	<body>
		<div id="block_page">
			...
			<div id="panneau_central">
				<h1>Commentaires</h1>
				<p><a href="BlogBillet.php">Retour a la liste des sujets</a></p>
				<?php VueBlog::afficheBillet($billet, false);?>
			
				<div class='commentaire'>
					<!-- <h2>Commentaires</h2> -->
				</div>
				<a href='CommentairesAjout.php?billet=<?php echo $_GET['billet']; ?>'>Ajouter un commentaire</a>
				<br/>
				<?php
					if(empty($commentaires)) { // si il n'y a pas de commentaires
						...
						foreach($commentaires as $key => $commentaire) {
							VueBlog::afficheCommentaire($commentaire);
						}
