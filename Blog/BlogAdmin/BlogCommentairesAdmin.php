<?php
	...
	if(!isset($_GET['billet']) || !is_numeric($_GET['billet'])) {
		...
		if ($billet == null || $billet->id() == 0 ) { // Si le billet n'est pas dans la base
			...
			require_once(dirname(dirname(dirname(__FILE__))).'/Erreur.class.php');
		...
		BlogCommentairesAdminVue::affiche($billet, $commentaires, $nbPagesAffiche, $nbPages, $page, $url);
